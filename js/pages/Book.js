            ...
            <div class="bg-white p-6 rounded-[2rem] shadow-xl border border-accent text-center relative overflow-hidden group hover:border-primary transition-all duration-300 shrink-0">
                ...
                <div class="flex space-x-3">
                    <button 
                        ...
                        class="flex-1 bg-white text-neutral border border-neutral/20 px-4 py-4 rounded-2xl font-bold text-sm hover:bg-neutral/5 transition transform active:scale-95 shadow-lg flex items-center justify-center space-x-2"
                    >
                    ...
                    <button 
                        ...
                        class="flex-1 bg-neutral text-white px-4 py-4 rounded-2xl font-bold text-sm hover:bg-primary transition transform active:scale-95 shadow-xl flex items-center justify-center space-x-2 group-hover:shadow-2xl"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
