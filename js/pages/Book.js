                ...
                <div class="flex space-x-3">
                    <div class="relative flex-1 h-16">
                        <button 
                            ...
                            class="absolute inset-0 bg-neutral text-white px-4 py-4 rounded-2xl font-bold text-sm hover:bg-primary transition transform active:scale-95 shadow-xl flex items-center justify-center space-x-2 group-hover:shadow-2xl ${notification ? 'opacity-0' : 'opacity-100'}"
                        >
