...
const HomePage = ({ onNavigate }) => {
    ...
    return html`
        <div class="flex flex-col h-full px-2 space-y-8 animate-fade-in bg-secondary">
            ...
            <div class="mt-4 pl-4">
                ...
                <p class="text-neutral text-lg mt-1">Bienvenue sur votre espace Kompo<span class="text-primary">.</span></p>
            </div>
            ...
            <div class="flex-1 flex flex-col space-y-4">
                ...
                <!-- Secondary Features -->
                <div class="h-48 grid grid-cols-2 gap-4">
                    <button 
                        onClick=${() => onNavigate('book')}
                        class="bg-white rounded-[2rem] p-6 shadow-xl border border-accent hover:border-primary transition-all duration-300 flex flex-col justify-between items-start text-left group hover:-translate-y-1 hover:shadow-2xl active:scale-95 active:shadow-md relative overflow-hidden"
                    >
                        ...
                        <span class="font-bold text-2xl text-neutral tracking-tight mt-4 group-hover:text-primary transition-colors">Book</span>
                    </button>
                    ...
                    >
                        ...
                        <span class="font-bold text-2xl text-neutral tracking-tight mt-4 group-hover:text-primary transition-colors">Agenda</span>
                    </button>
                </div>
            </div>
        </div>
